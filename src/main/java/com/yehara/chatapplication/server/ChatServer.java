package com.yehara.chatapplication.server;


import com.yehara.chatapplication.client.ChatClient;
...
public class ChatServer {
    ...
    public void initialize(){
        appendStatus("Server Strated, click 'Add client' to start");
    }
    ...
    private void openClientWindow() {
        Platform.runLater(() -> {
            try {
                FXMLLoader loader = new FXMLLoader(getClass().getResource("/com/yehara/chatapplication/chat_client.fxml"));
